...
I want to when clicked a event card then it will redirect the event details page like the following image ...but make sure the right side content will be fixed in the screen onlY left side content will be scrollable and also make sure the right side content will be visible on mobile devices as well...You must follow the overall colour combination of this website and make the super admin dashboard in the same colour combination. I want to use tailwind for this design. Can you help me with the code?
