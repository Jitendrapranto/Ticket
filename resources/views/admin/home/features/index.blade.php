...
<body class="bg-[#F1F5F9] font-plus" x-data="{
    deleteModal: false,
    deleteUrl: '',
    itemName: '',
    ...
    <div class="lg:ml-72 min-h-screen flex flex-col">
        ...
        <header class="h-20 bg-white/80 backdrop-blur-md border-b border-slate-100 flex items-center justify-between px-8 sticky top-0 z-40">
            <div>
                ...
                <p class="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Manage "Everything Optimized" Section Cards</p>
            </div>
            <a href="{{ route('admin.home.features.create') }}" class="bg-accent text-white px-6 py-2.5 rounded-xl text-xs font-black tracking-widest hover:bg-dark transition-all uppercase shadow-lg shadow-accent/20">
