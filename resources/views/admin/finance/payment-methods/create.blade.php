...
<div class="px-8 py-8 animate-fadeIn">
    ...
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between mb-12 gap-6">
        <div>
            ...
            <h1 class="text-3xl font-black text-dark italic tracking-tighter">New Payment <span class="text-primary underline decoration-primary/10 decoration-8 underline-offset-8">Gateway</span></h1>
        </div>
    </div>

    <!-- Form -->
    <form id="payment-form" action="{{ route('admin.finance.payment-methods.store') }}" method="POST" enctype="multipart/form-data" class="max-w-4xl">
        @csrf
