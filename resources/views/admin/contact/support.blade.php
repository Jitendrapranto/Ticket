                        ...
                        <div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-[9px] text-slate-400 mt-1 font-bold tracking-wider">Note: You can paste a link or upload a file below.</p>
                                </div>
                        ...
                        <div class="bg-slate-50 rounded-[2rem] p-6 flex items-center justify-center border border-dashed border-slate-200">
                             @if($support->image)
                                <div class="text-center">
                                    ...
                                    <img loading="lazy" src="{{ $support->image }}" alt="Preview" class="w-full max-h-48 object-cover rounded-2xl shadow-xl">
                                </div>
                             @else
