                        ...
                        <template x-for="(artist, index) in artists" :key="index">
                            <div class="grid grid-cols-12 gap-6 items-end group animate-fadeInUp">
                                ...
                                <div class="col-span-3 space-y-3">
                                    ...
                                    <input type="text" :name="'artists['+index+'][role]'" x-model="artist.role" required class="w-full bg-slate-50 border border-slate-100 rounded-xl py-4 px-6 outline-none text-sm font-black tracking-tighter shadow-inner" placeholder="e.g. Guest Comedian">
                                </div>
                                <div class="col-span-4 space-y-3">
                                    ...
                                    <label class="w-full h-[52px] bg-slate-50 border border-slate-100 rounded-xl flex items-center px-4 cursor-pointer hover:bg-slate-100 transition-all overflow-hidden relative group/file">
                                        ...
                                        <span class="text-[10px] font-bold text-slate-400 truncate" x-text="artist.imageName || 'Select Photo'"></span>
