    ...
    <div class="animate-fadeIn">
        <header class="mb-8 flex items-center justify-between shrink-0">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Update feature card: {{ $advantage->title }}</p>
                </div>
            </div>
        </header>
        ...
        <main class="max-w-4xl mx-auto">
            <div class="bg-white rounded-[2.5rem] shadow-premium border border-slate-50 overflow-hidden text-left">
                <form action="{{ route('admin.about.advantages.update', $advantage) }}" method="POST" class="p-10 space-y-8">
                    @csrf
                    @method('PUT')
                    
                    <div class="space-y-3 text-left">
                        <label class="text-[10px] font-black text-slate-400 tracking-[0.2em] uppercase ml-4">Title</label>
                        <input type="text" name="title" value="{{ old('title', $advantage->title) }}" class="w-full bg-slate-50 border border-slate-100 rounded-2xl py-5 px-6 outline-none focus:border-primary/30 focus:bg-white transition-all text-dark font-bold text-sm" placeholder="e.g. Speed & Security" required>
                    ...
                    <div class="space-y-3 text-left">
                        ...
                        <textarea name="description" rows="3" class="w-full bg-slate-50 border border-slate-100 rounded-[2rem] p-6 outline-none focus:border-primary/30 focus:bg-white transition-all text-dark font-medium text-sm leading-relaxed" placeholder="Briefly describe this advantage..." required>{{ old('description', $advantage->description) }}</textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div class="space-y-3 text-left">
                            ...
                            <input type="text" name="icon" value="{{ old('icon', $advantage->icon) }}" class="w-full bg-slate-50 border border-slate-100 rounded-2xl py-5 px-6 outline-none focus:border-primary/30 focus:bg-white transition-all text-dark font-mono text-sm font-bold" placeholder="fas fa-star" required>
                        ...
                        <div class="space-y-3 text-left">
                            ...
                            <input type="text" name="border_class" value="{{ old('border_class', $advantage->border_class) }}" class="w-full bg-slate-50 border border-slate-100 rounded-2xl py-5 px-6 outline-none focus:border-primary/30 focus:bg-white transition-all text-dark font-mono text-sm font-bold" placeholder="border-primary/20">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 pt-6 border-t border-slate-50">
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 gap-4">
                                <div class="flex items-center gap-4" x-data="{ color: '{{ old('card_bg_color', $advantage->card_bg_color) }}' }">
                                ...
                                <div class="flex items-center gap-4" x-data="{ color: '{{ old('icon_bg_color', $advantage->icon_bg_color) }}' }">
                                    <div class="w-12 h-12 rounded-xl overflow-hidden shadow-inner border border-slate-100 shrink-0">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 gap-4">
                                <div class="flex items-center gap-4" x-data="{ color: '{{ old('title_color', $advantage->title_color) }}' }">
                                    <div class="w-12 h-12 rounded-xl overflow-hidden shadow-inner border border-slate-100 shrink-0">
                                ...
                                <div class="flex items-center gap-4" x-data="{ color: '{{ old('desc_color', $advantage->desc_color) }}' }">
                                    <div class="w-12 h-12 rounded-xl overflow-hidden shadow-inner border border-slate-100 shrink-0">
                    ...
                    <div class="space-y-3 text-left">
                        ...
                        <input type="number" name="sort_order" value="{{ old('sort_order', $advantage->sort_order) }}" class="w-full bg-slate-50 border border-slate-100 rounded-2xl py-5 px-6 outline-none focus:border-primary/30 focus:bg-white transition-all text-dark font-bold text-sm">
                    </div>

                    <div class="pt-6 border-t border-slate-50 flex items-center justify-between">
                        <a href="{{ route('admin.about.advantages.index') }}" class="text-[10px] font-black text-slate-400 uppercase tracking-widest hover:text-dark transition-all">Cancel Update</a>
