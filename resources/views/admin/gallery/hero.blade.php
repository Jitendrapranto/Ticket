            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="bg-white rounded-[3rem] shadow-premium border border-slate-50 overflow-hidden animate-fadeInUp">
                    <div class="p-10 border-b border-slate-50 bg-slate-50/30 flex items-center justify-between">
                        <div>
                            <h3 class="font-outfit text-2xl font-black text-dark tracking-tight italic">Gallery Visual Hub</h3>
                    ...
                    <form action="{{ route('admin.gallery.hero.update') }}" method="POST" class="p-10 space-y-8">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="badge_text" value="{{ $hero->badge_text }}" class="w-full bg-slate-50 border border-slate-100 rounded-2xl py-5 pl-14 pr-8 outline-none focus:border-primary/30 focus:bg-white transition-all text-dark font-black text-sm italic" placeholder="e.g. VISUAL JOURNEY">
                            </div>
                        </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="title" value="{{ $hero->title }}" required class="w-full bg-slate-50 border border-slate-100 rounded-2xl py-5 pl-14 pr-8 outline-none focus:border-primary/30 focus:bg-white transition-all text-dark font-black text-sm italic" placeholder="e.g. Moments In Motion.">
                            </div>
                            <p class="text-[9px] text-slate-400 ml-4 italic">* Tip: Use a period at the end for a punchy, cinematic feel.</p>
                        </div>
                        ...
                        <div class="pt-6 border-t border-slate-50 flex items-center justify-between">
                            <p class="text-[10px] font-black text-slate-300 uppercase tracking-widest italic">Live Content Sync Active</p>
                            <button type="submit" class="bg-gradient-to-r from-primary to-primary-dark text-white px-12 py-5 rounded-[1.5rem] font-black text-xs tracking-[0.2em] shadow-premium hover:-translate-y-1 hover:shadow-2xl transition-all active:scale-95 uppercase italic flex items-center gap-3">
                ...
                <div class="mt-12 bg-dark rounded-[3.5rem] p-16 text-white relative overflow-hidden group border border-white/5 shadow-2xl">
                    ...
                    <div class="max-w-xl relative z-10 text-center mx-auto sm:text-left sm:mx-0">
                        ...
                        <h1 class="font-outfit text-5xl font-black mb-8 italic tracking-tighter leading-tight">{{ $hero->title }}</h1>
