...
@section('content')
<div class="min-h-screen -mt-40 flex items-center justify-center py-20 px-4 bg-[#1B2B46] relative overflow-hidden">
        ...
        <div class="hidden lg:flex flex-col justify-between p-12 bg-[#1A0222] text-white relative">
            ...
            <div class="relative z-10">
                ...
                <div class="mt-16 space-y-6">
                    <h2 class="font-outfit text-4xl font-black leading-tight tracking-tight">Access Your <span class="text-primary">Exclusive</span> Access.</h2>
                ...
                <div class="space-y-1" x-data="{ showPassword: false }">
                    ...
                    <div class="relative">
                        <input name="password" :type="showPassword ? 'text' : 'password'" required 
                            class="w-full bg-slate-50 border border-slate-100 rounded-xl py-3.5 px-4 pr-12 outline-none focus:border-primary/30 focus:bg-white transition-all text-sm font-bold shadow-inner"
                            placeholder="••••••••">
