...
Route::get('/gallery', function () {
    ...
    $galleryCategories = EventCategory::all();
    return view('gallery', compact('hero', 'dbImages', 'galleryCategories'));
})->name('gallery');
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['admin'])->group(function () {
            ...
            Route::get('/gallery/images/{image}/edit', [GalleryController::class , 'edit'])->name('gallery.images.edit');
            Route::put('/gallery/images/{image}', [GalleryController::class , 'update'])->name('gallery.images.update');
